...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<jdmartin1989-facilitator_api1.gmail.com>";
    private string APIPassword = "<1398633711>";
    private string APISignature = "<AN4Tngr7pnH.VO0DntgEhOjKGeGfAY8DmbtZRgSJHlQ55blLcScYFpLd>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:49320/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:49320/Checkout/CheckoutCancel.aspx";
